...
# Modifications:
# commented out tput to make the script work on Windows under Msys or Cygwin
# update this line to suit your project structure: pathSegment=$(expr "$validFile" : ".*/src/\(.*\)\..*")
...
do
        pathSegment=$(expr "$validFile" : ".*/src/\(.*\)\..*")
        fullyQualifiedClassName=${pathSegment//\//.}

#       tput rc
#       tput el
#       tput sc
          echo " ORPHAN TEST    : $fullyQualifiedClassName"
